...
<body>
	...
	<form action="UrbanspoonController" method="post">
		...
		<input type="text" name="cuisine_name"><br> <label>Country</label>
	...
	<form action="UrbanspoonController" method="post">
		...
		<label>Name</label>	<input type="text" name="recipe_name"><br> 
		<label>Description</label> <input type="text" name="description"><br> 
		<label>Type</label>	<input type="radio" name="recipe_type" value="Veg"> Veg 
		<input type="radio" name="recipe_type" value="Non-Veg"> Non-Veg<br> 
		<label>Cuisine</label>
